...
## 6. Qt / GUI ⏸ DEFERRED (2026-05-11)

UAT は延期。プラグインロード自体は §1 / §4 の起動ログで確認済み。
...
## 7. Python / Mu スクリプティング ⏸ DEFERRED (2026-05-11)
...
* [x] 4K EXR を 30 秒以上連続再生でメモリリーク無し（タスクマネージャ確認） — **PASS** (2026-05-11)

* [x] GPU 使用率が再生中に上がる（Intel/NVIDIA GPU で OpenGL レンダリング） — **PASS** (2026-05-11)

* [ ] 5 分間操作してクラッシュしない（未テスト）

* [ ] セッションファイル (.rv) の保存・読み込み（未テスト）
